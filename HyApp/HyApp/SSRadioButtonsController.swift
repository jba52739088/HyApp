...
class SSRadioButtonsController : NSObject
{
    ...
    init(buttons: UIButton...) {
        ...
        for aButton in buttons {
            aButton.addTarget(self, action: #selector(SSRadioButtonsController.pressed(_:)), for: .touchUpInside)
        }
    ...
    func removeButton(_ aButton: UIButton) {
        ...
        if(iteratingButton != nil) {
            ...
            iteratingButton!.removeTarget(self, action: #selector(SSRadioButtonsController.pressed(_:)), for: .touchUpInside)
